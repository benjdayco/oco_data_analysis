...
cofin_grants_loans_data = pd.read_csv("data_files/cofin_grants_extracted_approval_numbers.csv")
...
cofin_grants_loans_data[cofin_grants_loans_data['Extracted Approval Number'].str.len() != 4].to_csv("data_files/cofin_grant_loans_odd_approval_no_all.csv")
